$(document).ready(function () { //문서준비이벤트
    ...
    //history
    const h_2021_list = new Swiper('.h_2021_list', {
    ...
    const h_2020_list = new Swiper('.h_2020_list', {
    ...
    //breaker
    $('.pro1 > li:nth-child(1)').addClass('active');
    $('.pro1 > li').mouseenter(function () {
        $(this).addClass('active').siblings().removeClass('active');
    });

    $('.pro2 > li:nth-child(1)').addClass('active');
    $('.pro2 > li').mouseenter(function () {
        $(this).addClass('active').siblings().removeClass('active');
    });

    $('.pro1 > li:nth-child(1)').addClass('active_2');
    $('.pro1 > li').click(function () {
        $(this).addClass('active_2').siblings().removeClass('active_2');
    });

    $('.pro2 > li:nth-child(1)').addClass('active_2');
    $('.pro2 > li').click(function () {
        $(this).addClass('active_2').siblings().removeClass('active_2');
    });
